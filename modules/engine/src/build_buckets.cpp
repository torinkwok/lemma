...
int main(int argc, char *argv[])
{
    ...
    options.add_options()
            ("m,mode", "building mode", cxxopts::value<std::string>(),
             "[kmeans-emd, kmeans-euclidean, colex, hierarchical]"
            )
            ("p,private_cards", "number of private cards", cxxopts::value<int>(), "[2]")
            ("u,public_cards", "number of public cards, i.e. flop->3, turn->4, river->5", cxxopts::value<int>(),
             "[3:5]"
            )
