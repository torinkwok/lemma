#ifndef AUTODIDACT_MODULES_ENGINE_SRC_BUCKET_READER_HPP_
#define AUTODIDACT_MODULES_ENGINE_SRC_BUCKET_READER_HPP_
...
#endif //AUTODIDACT_MODULES_ENGINE_SRC_BUCKET_READER_HPP_
