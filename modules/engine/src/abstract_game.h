#ifndef AUTODIDACT_MODULES_ENGINE_SRC_ABSTRACT_GAME_H_
#define AUTODIDACT_MODULES_ENGINE_SRC_ABSTRACT_GAME_H_
...
#endif //AUTODIDACT_MODULES_ENGINE_SRC_ABSTRACT_GAME_H_
