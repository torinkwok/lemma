#ifndef AUTODIDACT_MODULES_ENGINE_SRC_RNBA_KERNEL_HPP_
#define AUTODIDACT_MODULES_ENGINE_SRC_RNBA_KERNEL_HPP_
...
#endif //AUTODIDACT_MODULES_ENGINE_SRC_RNBA_KERNEL_HPP_
