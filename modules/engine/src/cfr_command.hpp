#ifndef AUTODIDACT_MODULES_ENGINE_SRC_CFR_COMMAND_HPP_
#define AUTODIDACT_MODULES_ENGINE_SRC_CFR_COMMAND_HPP_
...
#endif //AUTODIDACT_MODULES_ENGINE_SRC_CFR_COMMAND_HPP_
