#ifndef AUTODIDACT_MODULES_ENGINE_SRC_ACTION_CHOOSER_HPP_
#define AUTODIDACT_MODULES_ENGINE_SRC_ACTION_CHOOSER_HPP_
...
#endif //AUTODIDACT_MODULES_ENGINE_SRC_ACTION_CHOOSER_HPP_
