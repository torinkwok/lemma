#ifndef AUTODIDACT_MODULES_ENGINE_SRC_HAND_BELIEF_H_
#define AUTODIDACT_MODULES_ENGINE_SRC_HAND_BELIEF_H_
...
#endif //AUTODIDACT_MODULES_ENGINE_SRC_HAND_BELIEF_H_
