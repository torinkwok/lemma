#ifndef AUTODIDACT_MODULES_CORE_INCLUDE_AUTODIDACT_CORE_UTIL_HPP_
#define AUTODIDACT_MODULES_CORE_INCLUDE_AUTODIDACT_CORE_UTIL_HPP_
...
struct SimpleTimer
{
    ...
    //      logger::debug("TIME SPENT [%s took %d ms]",
    //                    names_.at(i),
    //                    std::chrono::duration_cast<std::chrono::milliseconds>(
...
#endif //AUTODIDACT_MODULES_CORE_INCLUDE_AUTODIDACT_CORE_UTIL_HPP_