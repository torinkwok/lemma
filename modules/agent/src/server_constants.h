#ifndef AUTODIDACT_MODULES_AGENT_SRC_SERVER_CONSTANTS_H_
#define AUTODIDACT_MODULES_AGENT_SRC_SERVER_CONSTANTS_H_
...
#endif //AUTODIDACT_MODULES_AGENT_SRC_SERVER_CONSTANTS_H_
