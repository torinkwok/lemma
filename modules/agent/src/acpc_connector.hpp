#ifndef AUTODIDACT_MODULES_AGENT_INCLUDE_ACPC_CONNECTOR_HPP_
#define AUTODIDACT_MODULES_AGENT_INCLUDE_ACPC_CONNECTOR_HPP_
...
#endif //AUTODIDACT_MODULES_AGENT_INCLUDE_ACPC_CONNECTOR_HPP_
